	...
	<div class="main">
		<div class="price-off">
			...
			<ul class="product clearfix">
				...
				<li>
					<dl>
						<dt><a href="product-view.jsp" target="_blank"><img src=images/product/${disco.ep_id}.jpg /></a></dt>
							<dd class="title"><a href="product-view.jsp" target="_blank">${disco.ep_name}</a></dd>
		...
		<div class="side">
			...
			<div class="news-list">
				...
				<ul>
					...
					<li><a href="news-view.jsp?id=${news.en_id}" target="_blank">${news.en_title}</a></li>
					</c:forEach>
				</ul>
			</div>
		</div>
		...
		<div class="hot">
			...
			<ul class="product clearfix">
				...
				<li>
					<dl>
						<dt><a href="product-view.jsp" target="_blank"><img src="images/product/${selling.ep_id}.jpg" /></a></dt>
						<dd class="title"><a href="product-view.jsp" target="_blank">${selling.ep_name}</a></dd>
